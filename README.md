...
| 역할 | 담당 내용 |
|------|----------|
| 김수길 | 구조 설계 ,회원가입 및 로그인, 자유게시판 및 관련 기능, 공연게시판 및 관련 기능, 마이페이지 |
| 김원정 | 메인화면 공연 조회, 메인 페이지 css |
...
> 회원정보 수정, 예약 관련, 게시판 관련, 최근 본 공연 목록 한번에 조회 가능 
---
...
## 원본 레포지토리
[https://github.com/yujiyeon12/YuhanCon](https://github.com/youjiyeon12/YuhanCon)
